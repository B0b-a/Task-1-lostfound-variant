...
// Same shape as create, but nothing is required — PATCH is a partial
// update, so every field is optional and we still reject unknown/invalid
// values for anything the client did send.
